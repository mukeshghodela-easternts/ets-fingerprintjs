...
export const fingerprint_flash= fingerprint_flash();
export const fingerprint_canvas= fingerprint_canvas();
export const fingerprint_connection= fingerprint_connection();
export const fingerprint_cookie= fingerprint_cookie();
export const fingerprint_display= fingerprint_display();
export const fingerprint_fontsmoothing = fingerprint_fontsmoothing();
export const fingerprint_fonts= fingerprint_fonts();
export const fingerprint_formfields= fingerprint_formfields();
export const fingerprint_java= fingerprint_java();
export const fingerprint_language= fingerprint_language();
export const fingerprint_silverlight= fingerprint_silverlight();
export const fingerprint_os= fingerprint_os();
export const fingerprint_timezone= fingerprint_timezone();
export const fingerprint_touch= fingerprint_touch();
export const fingerprint_plugins= fingerprint_plugins();
export const fingerprint_useragent= fingerprint_useragent();
export const fingerprint_truebrowser= fingerprint_truebrowser();
